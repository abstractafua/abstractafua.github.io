...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: 'Engineering design project using SolidWorks CAD — Designed an innovative outdoor sprinkler system to mitigate wildfire damage in Kelowna, BC, demonstrating proficiency in digital & material solution design.',
      tags: ['CAD', 'SolidWorks'],
    ...
    },
     {
      ...
      desc: 'A real-time WebGL browser game where players race to eliminate growing bacteria colonies before they overtake a petri dish. Built entirely with raw WebGL and JavaScript. Features time-based growth animation, GLSL shaders, triangle-fan circle rendering, and Euclidean hit detection for mouse-click collision.',
